...
class MpesaController extends Controller
{
    ...
    public function customerMpesaSTKPush()
    {
        ...
        $curl_post_data = [
            ...
            'Amount' => $price,
            'PartyA' => $numbers, // replace this with your phone number
            'PartyB' => 174379,
            'PhoneNumber' => $numbers, // replace this with your phone number
            'CallBackURL' => 'https://blog.hlab.tech/',
            'AccountReference' => "H-lab tutorial",
            'TransactionDesc' => "elvis first lipa na mpesa"
        ];
    ...
    {
        $consumer_key="pDxVHZKi3Wrrt2VaafybyXDACAnBbC5f";
        $consumer_secret="cOIZ07CrmZebYGfI";
